...
- 릴선·연장선·휴대공구·대차 등 소모성 보조 공도구 또는 이동 보조장비의 교체·재체결·피복 감싸기만으로 끝난 건은, 실제 스파크·발열·감전충격·전도·작업자 직접 노출이 있었는지와 구분한다.
...
{{
  ...
  "simple_correction_evidence": ["단순 청소, 배수, 정리정돈, 위치변경, 교육, 재체결, 릴선·연장선·휴대공구·대차 교체, 피복 감싸기 등 근거"],
  ...
  "false_positive_guardrails": ["해당하는 가성 신호만 선택: 작업전발견, 작업예정, 사전협의, 허가요청, 기간연장, 실제물질없음, 센서테스트, SW경고, 계획정비알람, 단순교체교육, 소모성공도구교체, 행정절차"],
