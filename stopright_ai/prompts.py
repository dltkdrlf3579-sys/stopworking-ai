...
{{
  ...
  "pipe_support_evidence": {{
    ...
    "pipe_false_guardrail": ["해당하는 배관계열 가성 신호만 선택: 작업예정, 사전협의, 기간연장, 허가요청, 요청완료, 조치완료, DRI작성, 이메일공유, 파손유의, 단순이메일협의, 단순일정조율, 실제밟음불명확, 작업자노출불명확, 물리적보강없음, DS조치건, 협력회사자체개선완료, 협력회사자체판단"],
