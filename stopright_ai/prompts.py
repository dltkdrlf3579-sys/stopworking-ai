...
{{
  ...
  "pipe_support_evidence": {{
    ...
    "pipe_true_discriminator": ["해당하는 진성 구분자만 선택: 작업중실제밟음, 밟을수밖에없음, 안전발판부족, 금지설비밟음, 안전기준이탈승인, 물리적보강필요, 비계보강판설치, 작업방법변경"],
    "pipe_false_guardrail": ["해당하는 배관계열 가성 신호만 선택: 작업예정, 사전협의, 기간연장, 허가요청, 단순이메일협의, 단순일정조율, 실제밟음불명확, 물리적보강없음, 협력회사자체판단"],
